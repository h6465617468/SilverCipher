...
$key = "AC14";
# Use (Encrypt):
$encrypted_text = AC14::Encrypt($text,$key);
# Use (Decrypt):
$decrypted_text = AC14::Decrypt($encrypted_text,$key);
...
$key = "AC14";
# Use (Raw Encrypt):
$encrypted_text = AC14::Encrypt($text,$key,true);
# Use (Raw Decrypt):
$decrypted_text = AC14::Decrypt($encrypted_text,$key,true);
?>
*/
Class AC14
{
